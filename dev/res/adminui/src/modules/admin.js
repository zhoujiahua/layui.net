  ...
  admin.on('tabsPage(setMenustatus)', function(router){
    ...
    var matchMenu = function(list){
      list.each(function(index1, item1){
        ...
        var matched1 = path[0] == data1.name || (pathURL === data1.a.attr('lay-href'));

        listChildren1.each(function(index2, item2){
          var othis2 = $(item2);
          var data2 = getData(othis2);
          var listChildren2 = data2.list.children('dd');
          var matched2 = (path[0] == data1.name && path[1] == data2.name) || pathURL === data2.a.attr('lay-href');

          listChildren2.each(function(index3, item3){
            var othis3 = $(item3);
            var data3 = getData(othis3);
            var matched3 = pathURL === data3.a.attr('lay-href');
